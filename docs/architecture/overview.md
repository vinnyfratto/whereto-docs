...
```
  Mobile app (Expo / React Native)
        ...
        |   - flights: LiteAPI (active), Duffel (retired for solo, group checkout only)
  ...
  Supabase  ------------------------------------------
        ...
        +--> Duffel   (legacy; only group checkout still depends on it, see ADR-0009)
...
- **LiteAPI as the primary travel provider** ([ADR-0009](../decisions/0009-liteapi-primary-provider.md)):
  flights and hotels both moved to LiteAPI; Duffel is retired except for group checkout.

...
| [operations/techdocs-publishing.md](operations/techdocs-publishing.md) | How this folder becomes the public techdocs page |
...
| [vibes-engine/README.md](vibes-engine/README.md) | How the Vibe Engine content/ranking pipeline works, and where every region stands |
| [PACKAGE_PRICING_SELECTION.md](PACKAGE_PRICING_SELECTION.md) | How the flight and hotel are picked for any "package price," with examples |
...
| [iOSIssueandSolutionLog.md](iOSIssueandSolutionLog.md) | iOS-only bugs: symptom, root cause, fix — so a platform quirk doesn't get re-diagnosed from scratch next time |

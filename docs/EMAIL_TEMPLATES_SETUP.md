...
| Friend request — registered recipient | `friendRequestSentHtml` | `friend-notify` |
| Friend request — invite a non-user | `friendRequestInviteHtml` | `friend-notify` |
| Friend request accepted | `friendRequestAcceptedHtml` | `friend-notify` |

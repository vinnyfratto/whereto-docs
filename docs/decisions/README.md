...
| [0007](0007-posthog-sentry-deferred.md) | PostHog for analytics; error monitoring deferred | Superseded by ADR-0011 (error monitoring half) |
| [0008](0008-icon-codegen.md) | Icons via Solar/Iconify codegen | Accepted |
| [0009](0009-liteapi-primary-provider.md) | LiteAPI as the primary provider for both flights and hotels | Accepted |
| [0010](0010-image-resize-cache-strategy.md) | Resize and persistently cache destination photos instead of serving Storage originals | Accepted |
| [0011](0011-sentry-error-monitoring.md) | Sentry for crash and error monitoring in the app and Edge Functions | Accepted |

_The first eight were backfilled on 2026-07-05 from git history and project memory; 0009
was backfilled on 2026-08-01. Going

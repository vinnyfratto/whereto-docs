...
| Flights | LiteAPI (Nuitee Connect, server-side), behind `src/providers/flights/`. The only flight provider, for group trips as well as solo — see [ADR-0003](decisions/0003-server-side-travel-apis.md) and [GO_LIVE_LITEAPI.md](GO_LIVE_LITEAPI.md) |
